...
#ifndef BRACCIOLIBROS_H_
#define BRACCIOLIBROS_H_
...
public:
  ...
  */
   ...
   */
  void ServoMovement(unsigned int stepDelay, unsigned int vBase, unsigned int vShoulder, unsigned int vElbow, unsigned int vWrist_ver, unsigned int vWrist_rot, unsigned int vGripper);
